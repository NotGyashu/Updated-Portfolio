...
function Projects() {
  ...
  return (
    <div className="h-screen overflow-hidden cursor-none no-scrollbar text-white flex flex-col relative" style={{ height: '100dvh', height: '100vh' }}>
      ...
      <div className="flex md:gap-5 h-full gap-16 flex-col  p-2">
      <div
        className="flex  lg:mx-7 h-[80%]   gap-12 lg:gap-28 md:gap-16 justify-between overflow-x-scroll no-scrollbar"
        id="parent"
        ref={scrollRef}
        style={{
